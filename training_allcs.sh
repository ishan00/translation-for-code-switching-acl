MONO_DATASET='en:./data/All-CS/en.train.pth,,;hi:./data/All-CS/hi.train.pth,,'
PARA_DATASET='en-hi:./data/All-CS/XX.train.pth,./data/All-CS/XX.valid.pth,./data/All-CS/XX.test.pth'
PRETRAINED='./data/all.256.vec'

#CUDA_VISIBLE_DEVICES=0 
python3 main.py \
--exp_name training_allcs \
--transformer True \
--n_enc_layers 3 \
--n_dec_layers 3 \
--share_enc 2 \
...
--save_periodic True \
--reload_model dumped/training_opsub_emt/best-bleu_en_hi_en_valid.pth \
--reload_enc True \
--reload_dec True
# --eval_only True \
# --beam_size 10 \
